...
class DiscordNotificator(Notificator):
    ...
    def debug(self, msg: str) -> None:
        send_msg(settings.DISCORD_CHANNEL_HEALTH, format_msg(settings.LogLev.DEBUG, msg))

    def info(self, msg: str) -> None:
        send_msg(settings.DISCORD_CHANNEL_NEWS, format_msg(settings.LogLev.INFO, msg))

    def error(self, msg: str) -> None:
        send_msg(settings.DISCORD_CHANNEL_HEALTH, format_msg(settings.LogLev.ERROR, msg))
