...
DRIVER_VERSION = types.ChromeDriverVersion(cfg.get_str("driver_version", "114.0.5735.90"))

REDIS_HOST = types.RedisHostAddress(cfg.get_str("redis_host", "redis://localhost:6379/0"))
...
TELEGRAM_CHANNEL_HEALTH = types.TelegramChannelID(cfg.get_str("telegram_channel_health"))
